    ...
    <x-baseview title="{{ __('Summary Report') }}">
        ...
        <div class="p-4 border rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 md:grid-cols-3 lg:grid-cols-4">
                {{-- admin  --}}
                <div class="flex items-start p-4 space-x-4 border rounded-md shadow-sm">
                    <x-lineawesome-running-solid class="w-6 h-6"
                        style="color: {{ setting('appColorTheme.enrouteColor') }}" />
                    <div>
                ...
                {{-- store  --}}
                <div class="flex items-start p-4 space-x-4 border rounded-md shadow-sm">
                    <x-lineawesome-check-double-solid class="w-6 h-6"
                ...
                {{-- store  --}}
                <div class="flex items-start p-4 space-x-4 border rounded-md shadow-sm">
                    <x-lineawesome-exclamation-circle-solid class="w-6 h-6"
                        style="color: {{ setting('appColorTheme.failedColor') }}" />
                    <div>
                ...
                {{-- store  --}}
                <div class="flex items-start p-4 space-x-4 border rounded-md shadow-sm">
                    <x-lineawesome-ban-solid class="w-6 h-6 "
