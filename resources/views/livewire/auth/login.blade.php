                        ...
                        <div class="w-full">
                            ...
                            @if (setting('partnersCanRegister', true))
                                <div class="mt-4">
                                    ...
                                    <div
                                        class="block md:flex items-center justify-center space-x-1 md:space-x-4 rtl:space-x-reverse">
                                        <a href="{{ route('register.vendor') }}" class="w-full">
                                            <div
                                                class="w-full border shadow-sm rounded p-2 flex items-center justify-center space-x-2 rtl:space-x-reverse hover:shadow-md">
                                                <x-tabler-home-dollar class="w-6 h-6 text-primary-500" />
                                                <p class="md:my-2 text-sm font-medium">
                                                    {{ __('Vendor/Seller') }}
                                                </p>
                                            </div>
                                        </a>
                                        <a href="{{ route('register.driver') }}" class="w-full">
                                            <div
                                                class="w-full border shadow-sm rounded p-2 flex items-center justify-center space-x-2 rtl:space-x-reverse hover:shadow-md">
                                                <x-tabler-steering-wheel class="w-6 h-6 text-primary-500" />
                                                <p class="md:my-2 text-sm font-medium">
                                                    {{ __('Driver/Rider') }}
                                                </p>
                                            </div>
