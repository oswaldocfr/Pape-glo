    ...
    <div x-data="{ open: @entangle('showDetails') }">
        @if ($selectedModel != null)
            <x-modal-lg>
                ...
                @php
                    $selectedVendorIsParcel = $selectedModel->vendor_type->slug == 'parcel';
                    $selectedVendorIsService = $selectedModel->vendor_type->slug == 'service';
                    $isServiceOrParcelVendor = $selectedVendorIsParcel || $selectedVendorIsService;
                @endphp


                <div
                    class="grid grid-cols-1 gap-4 mt-4 border-t md:grid-cols-2 {{ $isServiceOrParcelVendor ? 'hidden' : 'block' }}">
                ...
                <div class="grid grid-cols-1 gap-4 pt-4 mt-4 border-t md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="{{ $isServiceOrParcelVendor ? 'hidden' : 'block' }}">
