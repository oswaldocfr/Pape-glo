    ...
    <x-baseview title="{{ __('Subscriptions') }}">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            @foreach ($subscriptions as $subscription)
                <div class="overflow-hidden text-center border rounded-md shadow-sm">
                    ...
                    <div class="my-2">
                        {{-- button --}}
                        <button
                            class="m-2 px-4 py-2 text-white bg-primary-400 hover:bg-primary-500 rounded hover:shadow"
