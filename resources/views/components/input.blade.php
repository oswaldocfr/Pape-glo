<label class="block {{ empty($title ?? '') ? '' : 'mt-4' }} text-sm">
    ...
    @endif
    <input
        {{ $attributes->merge(['class' => 'block w-full p-2 mt-1 text-sm border border-gray-300 rounded focus:border-primary-400 focus:outline-none focus:shadow-outline-primary']) }}
